      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-navy-foreground/80 leading-relaxed mb-6">
          ...
          <div>
            <h3 className="font-bold text-sm mb-4 uppercase tracking-wider text-navy-foreground">Services</h3>
          ...
          <div>
            <h3 className="font-bold text-sm mb-4 uppercase tracking-wider text-navy-foreground">Company</h3>
            <ul className="space-y-2 text-sm text-navy-foreground/80">
          ...
          <div>
            <h3 className="font-bold text-sm mb-4 uppercase tracking-wider text-navy-foreground">Contact</h3>
            <div className="space-y-3 text-sm text-navy-foreground/80">
            ...
            <div className="mt-6 flex gap-2">
              <div className="px-3 py-1.5 rounded-md glass-card-dark text-xs font-medium text-navy-foreground/80">
                🇳🇱 Amsterdam
              </div>
              <div className="px-3 py-1.5 rounded-md glass-card-dark text-xs font-medium text-navy-foreground/80">
                ⚡ Same-day
        ...
        <div className="border-t border-navy-light mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xs text-navy-foreground/70">
